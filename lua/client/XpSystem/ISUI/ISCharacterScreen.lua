...
--~ 	self.avatarPanel.render = ISCharacterScreen.drawAvatar;
	...
	local labelWid1 = getTextManager():MeasureStringX(UIFont.Small,getText("IGUI_char_Age"))
	local labelWid2 = getTextManager():MeasureStringX(UIFont.Small,getText("IGUI_char_Sex"))
	local labelWid3 = getTextManager():MeasureStringX(UIFont.Small,getText("IGUI_char_Weight"))
	local labelWid4 = getTextManager():MeasureStringX(UIFont.Small,getText("IGUI_char_Traits"))
	self.xOffset = self.avatarX + self.avatarWidth + 25 + math.max(labelWid1, labelWid2, labelWid3, labelWid4)
...
ISCharacterScreen.onCutHair = function(playerObj, hairStyle, time)
	...
	ISTimedActionQueue.add(ISCutHair:new(playerObj, hairStyle, scissors, time));
end
